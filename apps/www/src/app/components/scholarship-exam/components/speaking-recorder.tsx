...
import { formatDuration, resolveAssetUrl } from '../utils';
    ...
    <div className="te-speaking">
      {visualSrc ? (
        <div className="te-visual">
          <img src={visualSrc} alt={`Speaking visual for question ${question.questionNo}`} />
        </div>
      ) : null}
      ...
      <div className="te-speaking__body">
        ...
        {recorder.audioUrl ? (
          <audio className="te-speaking__audio" controls src={recorder.audioUrl}>
            Tarayiciniz ses oynatmayi desteklemiyor.
          </audio>
        ) : null}
