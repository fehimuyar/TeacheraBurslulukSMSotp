...
- Timestamp: 2026-03-23T14:15:51.154Z
- overall_pass: **true**
...
| db_campaign_school_coverage | WARN | campaign schools=26, expected>=130 |
| db_same_day_attr_school_coverage | WARN | same-day attribution schools=9, expected>=130 |
| db_same_day_channel_coverage | PASS | All expected channels observed: facebook, instagram, konya_avm, konya_outdoor, youtube |
