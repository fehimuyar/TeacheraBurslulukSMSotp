...
- Timestamp: 2026-03-24T18:15:03.442Z
- overall_pass: **false**
...
| db_total_schools_expected | PASS | db schools=595, expected>=130 |
| db_school_master_matches_csv | PASS | matched schools=130, expected>=130 |
| db_campaign_school_coverage | FAIL | campaign schools=69, expected>=130 |
| db_same_day_attr_school_coverage | FAIL | same-day attribution schools=2, expected>=130 |
